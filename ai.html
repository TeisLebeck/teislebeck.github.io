...
<h1 style="font-family: 'Lumanosimo', cursive; color: #ffd700;">A.I. Musikquizzen</h1>
</div>
<div id="introPage">
<p style="font-family: Arial, sans-serif; color: #ffd700; padding-top: 100px;">Ved hjælp at kunstig intelligens, er der lavet 32 billeder, som hver reprænsenterer en bestemt sang.</p>
...
<script>
    ...
    for (let i = array.length - 1; i > 0; i--) {
        ...
        var songs = [
            ...
            {name: 'Sweet home Alabama', image: 'https://cdn.midjourney.com/dce6c705-21c7-4e7f-a13f-0cb7d1628cd5/0_0.png', spotifyId: '7e89621JPkKaeDSTQ3avtg'},
